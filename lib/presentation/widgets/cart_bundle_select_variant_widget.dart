...
class CartSelectVariantWidget extends StatefulWidget {
  final VoidCallback onTap;
  const CartSelectVariantWidget({super.key, required this.onTap});

  @override
  State<CartSelectVariantWidget> createState() =>
      _CartSelectVariantWidgetState();
}

class _CartSelectVariantWidgetState extends State<CartSelectVariantWidget> {
